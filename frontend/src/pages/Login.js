        ...
        fetch('http://localhost:8081/login', {
            ...
            .then((data) => {
                if (data.message === 'Успешный вход') {
                    ...
                    } else if (data.role.toLowerCase() === 'кладовщик') {
                        navigate('/keeper'); // Панель Кладовщика
                    }else if (data.role.toLowerCase() === 'диспетчер') {
                        navigate('/dispatcher') //Панель Диспетчера
                    }else{
                        navigate('/courier') //Панель курьера
                    }
                } else {
                    alert('Ошибка входа');
                }
